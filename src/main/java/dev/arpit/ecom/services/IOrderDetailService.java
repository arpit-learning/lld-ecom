...
public interface IOrderDetailService {
  List<OrderDetail> createOrderDetails(Order order, List<ProductIdQuantityPair> orderDetails) throws InvalidProductIdException, NoInventoryExistForProductException;
